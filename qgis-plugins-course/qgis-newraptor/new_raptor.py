...
/***************************************************************************
 NewRaptor
                                 A QGIS plugin
 Add a new raptor nest, create buffer, and inpact table
...
class NewRaptor:
    ...
    def run(self):
        ...
        if self.first_start:
            ...
            # QMessageBox.information(self.dlg, "Message", "Run once")

        # QMessageBox.information(self.dlg, "Message", "Run many")
        ...
        if missing_layers:
            msg = "Te following layers are missing form the project\n"
        ...
        if result:
            ...
            # QMessageBox.information(self.dlg, "Message", "Run if OK")
            ...
            QMessageBox.information(self.dlg, "Message", "New Nest ID: {}\n\nLatitude: {}\nLongitude: {}\nSpecies: {}\nBuffer: {}\nStatus: {}\nLast: {}".format(valNestID, valLat, valLng, valSpecies, valBuffer, valStatus, valLast))
            ...
            # QMessageBox.information(self.dlg, "Message", "Run if Cancel")
            pass
